...
@UsesLibraries(libraries = "org.eclipse.paho.client.mqttv3-1.2.5.jar")
...
public class UrsPahoMqttClient extends MqttBase implements MqttCallbackExtended {
    ...
    void connect(final String funcName, final MqttConnectOptions connOpts) {
    	...
    	connOpts.setKeepAliveInterval(this.keepAlive);
    	connOpts.setMaxReconnectDelay(this.maxReconnectDelay);
    	connOpts.setMqttVersion(MqttConnectOptions.MQTT_VERSION_3_1_1);    	
    	connOpts.setMaxInflight(this.maxInflight);

    	if(this.userName != null) {
    	  connOpts.setUserName(this.userName);
    	  Log.d(LOG_TAG, "userName set to " + connOpts.getUserName());
    	  
    	}
    	if(this.userPassword != null ) {
    	  connOpts.setPassword(this.userPassword.toCharArray());
    	  Log.d(LOG_TAG, "userPassword set to " + connOpts.getPassword());
        ...
        if (protocol.equals("TCP")) {
            ...
            Log.d(LOG_TAG, "uri is " + serverUri);
        } else {
