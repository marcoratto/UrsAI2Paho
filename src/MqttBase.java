...
public class MqttBase extends AndroidNonvisibleComponent {
    ...
    @SimpleProperty(category = PropertyCategory.BEHAVIOR,
					description = "Set the maximum time to wait between reconnects [millis].")
    public void MaxReconnectDelay(int value) {
        if (value >= 0)
    ...
    public void AutomaticReconnect(boolean value) {
    ...
    void raiseIsConnectionAborted(String functionName, MqttException me) {
		...
		Log.d(LOG_TAG, "connectionState:" + connectionState);
		Log.d(LOG_TAG, "lastErrMsg:" + lastErrMsg);
		Log.d(LOG_TAG, "lastErrorCode:" + lastErrorCode);
    ...
    public YailDictionary ToDictionary() {
        ...
        dict.put("MaxInflight", maxInflight);
         ...
         dict.put("AutomaticReconnect", automaticReconnect);
    ...
    public void FromDictionary(YailDictionary dict) {
        try {
            ...
            getBoolean(dict, "AutomaticReconnect");
        ...
        try {
            ...
            automaticReconnect = getBoolean(dict, "AutomaticReconnect");
